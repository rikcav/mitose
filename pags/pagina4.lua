...
function scene:create(event)
    ...
    nextButton:addEventListener("tap", function() composer.gotoScene("pags.pagina5", {effect = "slideLeft", time = 500}) end)
    prevButton:addEventListener("tap", function() composer.gotoScene("pags.pagina3", {effect = "slideRight", time = 500}) end)
end
